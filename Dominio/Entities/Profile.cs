...
namespace Domain.Entities
{
    ...
    public class Profile
    {
        ...
        [FirestoreProperty]
        public List<string>? NameProfilePrefixes { get; set; } = new List<string>();//lo genero yo
        ...
        [FirestoreProperty]
        public string? User1Password { get; set; }
        [FirestoreProperty]
        ...
        [FirestoreProperty]
        public string? User1CurrentProvince { get; set; }
        [FirestoreProperty]
        ...
        [FirestoreProperty]
        public string? User2CurrentProvince { get; set; } = null;
        [FirestoreProperty]
        ...
        [FirestoreProperty]
        public string? User2GeoHash { get; set; }
        [FirestoreProperty]
